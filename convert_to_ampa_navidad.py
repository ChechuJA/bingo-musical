#!/usr/bin/env python3
"""Convierte el formato estándar al formato AMPA para Navidad."""
from pathlib import Path

md_file = Path("cartones/ampa/FiestaNavidad/Navidad2026/cartones-navidad-2026.md")
...
output = Path("cartones/ampa/FiestaNavidad/cartones-bingo-musical-navidad-1.md")
output.write_text("\n".join(result) + "\n", encoding="utf-8")
