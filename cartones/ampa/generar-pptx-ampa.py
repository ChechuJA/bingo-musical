#!/usr/bin/env python3
"""Regenera PPTX y PDF para los cartones de AMPA Colegio Peñamiel.

Parsea el formato propio del MD de AMPA:
  {pos} - {num} Artista - Título

Uso:
  python cartones/ampa/generar-pptx-ampa.py

Desde la raíz del proyecto, o desde la carpeta ampa:
  python generar-pptx-ampa.py
"""
...
CARPETA_FIESTA_VERANO = SCRIPT_DIR / "FiestaVerano"
MD_FILE   = CARPETA_FIESTA_VERANO / "cartones-bingo-musical-varios-1.md"
PPTX_FILE = CARPETA_FIESTA_VERANO / "cartones-bingo-musical-varios-1.pptx"
PDF_FILE  = CARPETA_FIESTA_VERANO / "cartones-bingo-musical-varios-1.pdf"
LOGO_FILE = SCRIPT_DIR / "ampa.png"

CATEGORIA = "Bingo Musical – Fiesta de Verano AMPA Peñamiel"
