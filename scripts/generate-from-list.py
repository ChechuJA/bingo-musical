...
def main() -> None:
    ...
    if len(sys.argv) == 1:
        ...
        parser.add_argument("--logo", default=None, help="Ruta al logo principal")
        parser.add_argument("--official-logo", default="images/logooficial.png", help="Ruta al logo secundario/oficial")
        parser.add_argument("--logo-width", type=float, default=0.8)
        parser.add_argument("--official-logo-scale", type=float, default=0.8, help="Escala del logo secundario/oficial")
        parser.add_argument("--custom-logo-scale", type=float, default=1.5, help="Escala del logo principal")
